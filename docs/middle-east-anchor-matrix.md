# Middle East Anchor Matrix

Cross-border wayfinding/signage consultancy players in the GCC region (god-tier or strong premium).

| Company | HQ/Base Country | Active Countries | Service Model | Sector Strengths | Confidence | Source Links |
|---------|-----------------|-------------------|---------------|------------------|------------|--------------|
| **LIMAH** | UAE (Dubai) | UAE, Bahrain, KSA, Qatar | Strategy + Fabrication (end-to-end) | Luxury hospitality, airports, mixed-use, retail, civic | High | https://www.limahdesign.com/ |
| **Green Vision Consultants (GVC)** | UAE (Dubai) | UAE, KSA, Qatar, Kuwait, Oman, Bahrain | Strategy-only / Strategy+Consultancy | Airports, mega-developments, healthcare, retail, mixed-use | High | https://www.greenvisioncons.com/ |
| **GLSW (Genius Loci Signage & Wayfinding)** | UAE (Dubai) | UAE (HQ), operates worldwide | Strategy + Fabrication | Mixed-use, luxury hospitality, master-planned destinations | High | https://www.gl-sw.com/ |
| **Creative Dialog** | UAE (Dubai) | UAE, Middle East | Strategy + Fabrication (full BIM integration) | Luxury hospitality, mixed-use, retail, destination branding | High | https://creativedialog.ae/ |
| **Dezign Technic** | UAE (Dubai) | UAE, Qatar, Lebanon, Egypt, UK | Strategy + Fabrication (full service) | Mixed-use, retail, cultural venues, master-planned communities | High | https://www.dezigntechnic.com/ |
...
- **LIMAH**: Pioneer of modern wayfinding in Middle East. Landmark projects: Al Qana (Abu Dhabi), Diyar Al Muharraq (Bahrain), La Mer (Dubai), Bulgari Resort, Yas Bay, Deira Mall. Wayfinding + customer experience + public art.
- **Creative Dialog**: "200+ projects for leading developers." Full BIM integration. Strategy-forward consultancy with end-to-end delivery. Known for dual Arabic-English design expertise.
- **GVC (Green Vision Consultants)**: Regional leaders with explicit cross-border coverage (UAE, KSA, Qatar, Kuwait, Oman, Bahrain). BIM LOD 300. Sustainability-focused. Mega-developments focus.

### Tier 2 - Strong Premium
- **GLSW**: Dubai-based, worldwide operations. Focus on "comprehensive and engaging experience journeys." Notable for master-planned destinations.
- **Dezign Technic**: 21 years experience. Offices in UAE, Qatar, Lebanon, Egypt, UK, Spain. Full "concept to closeout" service. Notable project: Infinity des Lumières (Dubai).
- **Projective**: KSA-headquartered with UAE presence. 10+ years UAE experience. Strategy + fabrication.
- **Dar Al-Handasah**: Large regional AEC firm with dedicated EGD team. Pan-Middle East presence.
